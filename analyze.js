...
export default async function handler(request,response){
  ...
  try{
    ...
    const filtered=comparableFilter(items,20,{title:q,query:q,sys:request.query.sys||""}), chosen=filtered.out, compact=String(request.query.compact||"")==="1";
